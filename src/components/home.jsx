        ...
        <div>
          <nav className="fixed top-0 w-full z-50 flex items-center justify-between px-10 py-4 bg-gradient-to-b from-black/90 to-transparent">
            ...
            <div className="flex items-center gap-5">
              <SearchBar />
              <div
                className="px-4 py-1 cursor-pointer hover:bg-purple-600/70 transition-colors duration-200 font-semibold bg-purple-600 rounded-md"
                disabled={!activeUser}
                onClick={() => navigate("/profile")}
              >
                {activeUser ? activeUser.email : "Guest"}
              </div>
            </div>
          </nav>
